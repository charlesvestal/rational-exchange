...
class LocaleList {
    ...
    init() {
        countryList = [
            ...
            Country(name: "United States (USA)", currencyName: "US Dollar", currencyCode: "USD", exchangeRate: 1, tipRate: 0.15, additionalTaxRate:0.0, precision:1.0),
        ...
        localeList = [
            ...
            Locale(name: "Alabama", additionalTaxRate: 0.085100000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Alaska", additionalTaxRate: 0.016900000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Arizona", additionalTaxRate: 0.081700000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Arkansas", additionalTaxRate: 0.091900000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "California", additionalTaxRate: 0.084100000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Colorado", additionalTaxRate: 0.073900000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Connecticut", additionalTaxRate: 0.063500000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Delaware", additionalTaxRate: 0.000000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Florida", additionalTaxRate: 0.066200000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Georgia", additionalTaxRate: 0.069700000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Hawaii", additionalTaxRate: 0.043500000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Idaho", additionalTaxRate: 0.060300000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Illinois", additionalTaxRate: 0.081600000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Indiana", additionalTaxRate: 0.070000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Iowa", additionalTaxRate: 0.067800000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Kansas", additionalTaxRate: 0.081500000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Kentucky", additionalTaxRate: 0.060000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Louisiana", additionalTaxRate: 0.088900000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Maine", additionalTaxRate: 0.055000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Maryland", additionalTaxRate: 0.060000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Massachusetts", additionalTaxRate: 0.062500000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Michigan", additionalTaxRate: 0.060000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Minnesota", additionalTaxRate: 0.071900000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Mississippi", additionalTaxRate: 0.070000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Missouri", additionalTaxRate: 0.075800000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Montana", additionalTaxRate: 0.000000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Nebraska", additionalTaxRate: 0.067900000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Nevada", additionalTaxRate: 0.079300000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "New Hampshire", additionalTaxRate: 0.000000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "New Jersey", additionalTaxRate: 0.069700000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "New Mexico", additionalTaxRate: 0.072600000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "New York", additionalTaxRate: 0.084700000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "North Carolina", additionalTaxRate: 0.069000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "North Dakota", additionalTaxRate: 0.065500000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Ohio", additionalTaxRate: 0.071100000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Oklahoma", additionalTaxRate: 0.087200000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Oregon", additionalTaxRate: 0.000000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Pennsylvania", additionalTaxRate: 0.063400000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Rhode Island", additionalTaxRate: 0.070000000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "South Carolina", additionalTaxRate: 0.071900000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "South Dakota", additionalTaxRate: 0.058300000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Tennessee", additionalTaxRate: 0.094500000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Texas", additionalTaxRate: 0.081500000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Utah", additionalTaxRate: 0.066800000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Vermont", additionalTaxRate: 0.061400000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Virginia (b)", additionalTaxRate: 0.056300000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Washington", additionalTaxRate: 0.088800000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "West Virginia", additionalTaxRate: 0.060700000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Wisconsin", additionalTaxRate: 0.054300000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "Wyoming", additionalTaxRate: 0.054900000, tipRate: 0.20, country: getCountry("USA")),
            Locale(name: "D.C.", additionalTaxRate: 0.057500000, tipRate: 0.20, country: getCountry("USA")),
        ]
