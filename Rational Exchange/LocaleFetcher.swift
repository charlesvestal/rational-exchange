...
class LocaleList {
    ...
    init() {
        countryList = [
            ...
            Country(name: "Georgia", currencyName: "Georgian Lari", currencyCode: "GEL", exchangeRate: 1.7381500000000001, tipRate:nil, additionalTaxRate:nil, precision:1.0, tipString:nil, taxString:nil, ISOAbbreviation:"GE"),
            ...
            Country(name: "England", currencyName: "Pound Sterling", currencyCode: "GBP", exchangeRate: 0.614838, tipRate:0.1, additionalTaxRate:nil, precision:1.0, tipString:"Bartenders don't expect tips.", taxString:nil, ISOAbbreviation:"_england"),
